...
class CartaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Carta::create([
            ...
            'estilo_preparacion'   => '',
            'alergenos'            => json_encode(['crustáceos', 'sulfitos']),
        ]);
        ...
        Carta::create([
            ...
            'estilo_preparacion'   => '',
            'alergenos'            => json_encode(['crustáceos', 'pescado']),
        ]);
        ...
        Carta::create([
            ...
            'estilo_preparacion'   => '',
            'alergenos'            => json_encode(['crustáceos', 'pescado', 'huevo']),
        ]);
        ...
        Carta::create([
            ...
            'estilo_preparacion'   => '',
            'alergenos'            => json_encode(['crustáceos', 'huevo']),
        ]);
        ...
        Carta::create([
            ...
            'precio_media_racion'  => '',
            'categoria'            => 'Variados',
            'imagen'               => 'images/platos/revuelto-champiñones.jpg',
            'estilo_preparacion'   => '',
            'alergenos'            => json_encode(['huevo']),
        ]);
        ...
        Carta::create([
            ...
            'precio_media_racion'  => '',
            'categoria'            => 'Carnes',
            'imagen'               => 'images/platos/presa-entraña-brasa.jpg',
            'estilo_preparacion'   => 'A la brasa',
            'alergenos'            => json_encode(['gluten']),
        ]);
